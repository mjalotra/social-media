...
/**
 * Follower service implementation that allows the capability to follow or unfollow a followee.
...
public class FollowerServiceImpl implements FollowerService{
	...
	/**
	 * A common implementation that allows follow/unfollow a followee
	 * based upon the follower id provided and the action value
	 * @param followerId current user Id
	 * @param followeeId followee id, user wants to follow/unfollow
	 * @param action can be either of <li> follow</li> <li>unfollow</li>
	 * @return
	 */
